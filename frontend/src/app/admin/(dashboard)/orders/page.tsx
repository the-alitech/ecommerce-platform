...
import { adminApi, BACKEND_URL, type AdminOrder } from '@/lib/admin-api';

export default function OrdersPage() {
  const [orders, setOrders] = useState<AdminOrder[]>([]);

  useEffect(() => {
    adminApi<{ results: AdminOrder[] }>('/dashboard/orders/')
      .then((d) => setOrders(d.results || (d as unknown as AdminOrder[])))
      .catch(console.error);
  }, []);
